...
* @see https://v0.dev/t/8uBZFhxQp1K
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" className="gap-1 rounded-xl px-3 h-10 data-[state=open]:bg-muted text-lg">
                Mental Health Support <span className="text-muted-foreground">v1.0</span>
            ...
            <div className="grid gap-1">
              ...
              <div className="prose text-muted-foreground">
                ...
                <ul>
                  ...
                  <li>Go for a walk or do some light exercise</li>
                  <li>Spend time in nature or do an activity you enjoy</li>
